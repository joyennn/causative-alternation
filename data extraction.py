...
#Extract sentences containing specific verbs
...
def main():
    verb_file = input("Verb list fiile: ") 
    data_file = input("Tagged file: ") 
    folder_name = input("New folder name (if you don't need to, press ENTER): ")
    header = input("New file name: ") 

    try:
        verb_list = read_verb_list(verb_file)
    except FileNotFoundError:
        print("There's no Verb list file!")
        return

    try:
        data = read_tagged_file(data_file)
    except FileNotFoundError:
        print("There's no Tagged file!")
        return
